...
# access_token 발급 
def issue_access_token(s_id: str, response : Response, expires_delta: timedelta | None = None):
    # Access Token 생성
    access_token_data = {
        "sub": s_id,  # 사용자 세션 ID
    ...
    rd.set(f"refresh_token:{s_id}", refresh_token, ex=token.REFRESH_TOKEN_EXPIRE_MINUTES * 60)  
